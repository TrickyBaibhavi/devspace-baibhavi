  ...
  const services = [
    {
      ...
      title: "Web Design",
      description: "Creating visually appealing and user-friendly websites with clean layouts and easy navigation."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Building responsive interfaces with modern frameworks like React.js, HTML5, CSS3, and Tailwind CSS."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Creating robust server-side applications with Node.js, Express.js, and MongoDB for data persistence."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Designing and implementing scalable APIs that connect your frontend to backends and third-party services."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Implementing secure authentication and data protection with practices like password hashing and JWT."
    },
    {
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: "Creating efficient database schemas and implementing data models optimized for your application's needs."
    }
  ];
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto">
            I offer a range of services to help bring your web application ideas to life, focusing on creating seamless user experiences.
          </p>
        </div>
