    ...
    <section id="about" className="section-padding bg-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <Card className="bg-portfolio-card p-6 card-shadow rounded-xl">
            ...
            <ul className="space-y-4 text-sm">
              <li>
                ...
                <div className="text-gray-500">Expected 2026, CGPA 8.96</div>
              </li>
              <li>
                ...
                <div className="text-gray-500">2022, CGPA 8.0, 2nd in batch</div>
              </li>
              <li>
          ...
          <Card className="bg-portfolio-card p-6 card-shadow rounded-xl">
            ...
            <div className="mb-4">
              ...
              <div className="text-gray-500">May 2023 - Present</div>
